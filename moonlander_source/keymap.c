...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    KC_CAPSLOCK,    KC_LCTRL,       KC_LALT,        KC_LGUI,        KC_LSHIFT,      OSL(4),                                                                                                         OSL(4),         KC_RSHIFT,      KC_RGUI,        KC_RALT,        KC_RCTRL,       KC_CAPSLOCK,    
    KC_SPACE,       TD(DANCE_0),    TD(DANCE_1),                    TD(DANCE_2),    TD(DANCE_3),    KC_ENTER
  ),
  [1] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                 KC_TRANSPARENT, LGUI(LSFT(KC_TAB)),KC_END,         KC_UP,          KC_PGDOWN,      LGUI(KC_TAB),   KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 LCTL(LSFT(KC_TAB)),KC_LEFT,        KC_DOWN,        KC_RIGHT,       LCTL(KC_TAB),   KC_TRANSPARENT, 
    TO(0),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, OSL(5),                                                                                                         OSL(5),         KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [2] = LAYOUT_moonlander(
    ...
    TO(0),          RGB_VAD,        RGB_VAI,        HSV_172_255_255,RGB_MOD,        OSL(6),                                                                                                         OSL(6),         KC_MS_ACCEL2,   KC_TRANSPARENT, KC_MS_WH_LEFT,  KC_MS_WH_DOWN,  KC_MS_WH_RIGHT, 
  ...
  [4] = LAYOUT_moonlander(
    ...
    KC_RSHIFT,      KC_SLASH,       KC_DOT,         KC_COMMA,       KC_M,           KC_N,                                           KC_B,           KC_V,           KC_C,           KC_X,           KC_Z,           KC_LSHIFT,      
    ...
    KC_ENTER,       KC_TAB,         KC_NO,                          KC_NO,          KC_BSPACE,      KC_SPACE
  ),
  [5] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, LGUI(LSFT(KC_TAB)),KC_PGDOWN,      KC_UP,          KC_END,         LGUI(KC_TAB),   KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, LCTL(LSFT(KC_TAB)),KC_LEFT,        KC_DOWN,        KC_RIGHT,       LCTL(KC_TAB),                                   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
