...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    KC_GRAVE,       KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           KC_6,                                           KC_BSPACE,      KC_7,           KC_8,           KC_9,           KC_0,           KC_MINUS,       KC_EQUAL,       
    KC_TAB,         KC_Q,           KC_W,           KC_E,           KC_R,           KC_T,           TD(DANCE_0),                                    TD(DANCE_2),    KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           KC_BSLASH,      
    KC_CAPSLOCK,    KC_A,           KC_S,           KC_D,           KC_F,           KC_G,           TD(DANCE_1),                                                                    TD(DANCE_3),    KC_H,           KC_J,           KC_K,           KC_L,           KC_SCOLON,      KC_QUOTE,       
  ...
  [1] = LAYOUT_moonlander(
    KC_ESCAPE,      KC_F1,          KC_F2,          KC_F3,          KC_F4,          KC_F5,          KC_F6,                                          KC_DELETE,      KC_F7,          KC_F8,          KC_F9,          KC_F10,         KC_F11,         KC_F12,         
    ...
    TO(0),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, OSL(5),                                                                                                         OSL(5),         KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_PGDOWN,      
  ...
  [2] = LAYOUT_moonlander(
    ...
    TO(0),          RGB_VAD,        RGB_VAI,        HSV_172_255_255,KC_TRANSPARENT, OSL(6),                                                                                                         OSL(6),         KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_WH_LEFT,  KC_MS_WH_DOWN,  KC_MS_WH_RIGHT, 
  ...
  [3] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, KC_KP_4,        KC_KP_5,        KC_KP_6,        KC_KP_PLUS,     KC_CALCULATOR,  KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_CALCULATOR,  KC_KP_4,        KC_KP_5,        KC_KP_6,        KC_KP_PLUS,     KC_TRANSPARENT, 
    ...
    TO(0),          KC_KP_COMMA,    KC_KP_0,        KC_KP_DOT,      KC_BSPACE,      KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_KP_COMMA,    KC_KP_0,        KC_KP_DOT,      KC_BSPACE,      KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [4] = LAYOUT_moonlander(
    KC_EQUAL,       KC_MINUS,       KC_0,           KC_9,           KC_8,           KC_7,           KC_BSPACE,                                      KC_6,           KC_5,           KC_4,           KC_3,           KC_2,           KC_1,           KC_GRAVE,       
    KC_BSLASH,      KC_P,           KC_O,           KC_I,           KC_U,           KC_Y,           KC_NO,                                          KC_NO,          KC_T,           KC_R,           KC_E,           KC_W,           KC_Q,           KC_TAB,         
    KC_QUOTE,       KC_SCOLON,      KC_L,           KC_K,           KC_J,           KC_H,           KC_NO,                                                                          KC_NO,          KC_G,           KC_F,           KC_D,           KC_S,           KC_A,           KC_CAPSLOCK,    
    KC_SLASH,       KC_UP,          KC_DOT,         KC_COMMA,       KC_M,           KC_N,                                           KC_B,           KC_V,           KC_C,           KC_X,           KC_Z,           KC_LSHIFT,      
    KC_LEFT,        KC_DOWN,        KC_RIGHT,       KC_RCTRL,       KC_RALT,        KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_LALT,        KC_LCTRL,       KC_LBRACKET,    KC_RBRACKET,    TO(0),          
    KC_ENTER,       KC_RSHIFT,      KC_RGUI,                        KC_LGUI,        KC_LSHIFT,      KC_SPACE
  ),
  [5] = LAYOUT_moonlander(
    KC_F12,         KC_F11,         KC_F10,         KC_F9,          KC_F8,          KC_F7,          KC_DELETE,                                      KC_F6,          KC_F5,          KC_F4,          KC_F3,          KC_F2,          KC_F1,          KC_ESCAPE,      
    ...
    KC_PGDOWN,      KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, TO(0),          
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [6] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN2,     KC_MS_UP,       KC_MS_BTN1,     KC_TRANSPARENT, KC_NO,                                                                          KC_NO,          KC_TRANSPARENT, KC_TRANSPARENT, HSV_0_255_255,  RGB_HUI,        RGB_HUD,        MU_MOD,         
    ...
    KC_MS_WH_LEFT,  KC_MS_WH_DOWN,  KC_MS_WH_RIGHT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_TRANSPARENT, HSV_172_255_255,RGB_VAI,        RGB_VAD,        TO(0),          
